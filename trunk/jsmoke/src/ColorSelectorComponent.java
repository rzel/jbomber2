...
class HexRGBColorSelectorComponent extends JPanel implements ActionListener {
	...
	private void updateTextField(int r, int g, int b) {
		String text = Format142.strformat("%02x%02x%02x", new int[] { r, g, b });
		rgbHex.setText(text);
	}
...
class ColorConverter {
	...
	public static Color hsvToColor(double h, double s, double v) {
		return Color.getHSBColor((float)(h / ColorSelectorComponent.MAX_HUE),
		                         (float)(s / ColorSelectorComponent.MAX_SATURATION),
		                         (float)(v / ColorSelectorComponent.MAX_VALUE));
	}
	...
	public static int[] hsvToRgb(double h, double s, double v) {
		int[] result = new int[3];
		int color = Color.HSBtoRGB((float)(h / ColorSelectorComponent.MAX_HUE),
		                           (float)(s / ColorSelectorComponent.MAX_SATURATION),
		                           (float)(v / ColorSelectorComponent.MAX_VALUE));
