...
public class ColorConversion {
	static void rgb2ycbcr(int r, int g, int b, int[] ycbcr) {
	...
	static void rgb2yuv(int r,int g, int b, int[] yuv) {
		int y = (int)(0.299 * r + 0.587 * g + 0.114 * b);
	...
	static void rgb2hsb(int r, int g, int b, int[] hsb) {
		float [] hsbvals = new float[3];
		Color.RGBtoHSB(r, g, b, hsbvals);
	}

	static void rgb2hmmd(int r, int g, int b, int[] hmmd) {
	...
	public static void rgb2xyY(int R, int G, int B, int []xyy) { //http://www.brucelindbloom.com
		float rf, gf, bf;
		float r, g, b, X, Y, Z;
	...
	public static void rgb2lab(int R, int G, int B, int []lab) { //http://www.brucelindbloom.com
	...
	public static void rgb2luv(int R, int G, int B, int []luv) { //http://www.brucelindbloom.com
		float rf, gf, bf;
